...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // component.card (DESIGN.md v2.0 §4.6): radius.none, borda 1px Mist
        // (border-border), SEM sombra por padrão — no sistema de cantos
        // retos, o hairline (a borda) faz o trabalho que shadow.syntaxisSm
        // fazia na v1.x. Nunca card sem borda flutuando sobre o fundo Chalk.
